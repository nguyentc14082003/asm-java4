...
<head>
<meta charset="UTF-8">
<title>Quên mật khẩu - N8Rubik</title>
						...
						<div class="card-body p-0">
							<div class="row">
								...
								<div class="col-12">
									<div class="px-4">
										<h2
											class="text-muted fw-bold text-center my-4 animate__animated animate__fadeInDown">Khôi
											phục mật khẩu</h2>
										<form action="forgot-password" method="post">
											...
											<div class="form-group mb-3">
												<label for="veriCode"
													...
													xác nhận:</label> <input type="password"
													class="form-control animate__animated animate__fadeInRight"
